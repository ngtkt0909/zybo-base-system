...
xv_path="R:/Xilinx/Vivado/2017.1"
...
{
  file="xsim.ini"
  lib_map_path="R:/Xilinx/Vivado/2017.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
